...
def parse_args(argv: List[str] | None = None):
    ...
    p.add_argument("input", help="Flattened CSV (from flatten_sweep.py) or weight sweep CSV")
    p.add_argument("output", help="Output PNG file")
    p.add_argument("--domain", default=None, help="Filter to a single domain")
    p.add_argument("--normalize", default=None, help="Filter rows by normalization mode (if present in CSV)")
    p.add_argument("--mode", choices=["scatter","heatmap"], default="scatter", help="Plot mode: scatter (default) or heatmap")
    p.add_argument("--heatmap-x", default="weight_count", help="Heatmap X-axis field (default: weight_count)")
    p.add_argument("--heatmap-y", default="weight_yield", help="Heatmap Y-axis field (default: weight_yield)")
